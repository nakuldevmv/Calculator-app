...
import 'package:getxapptest/webview/webViewContainer.dart';
...
class calculator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //ive changed the mediaQuery just to put it on a website use mediaquery instead of hardcoded value when developing mob app
    ...
    const ratioh = screenHeight > 592.0 ? screenHeight / 290 : screenHeight / 150;
    const ratiow = screenWidth > 360.0 ? screenWidth / 394 : screenWidth / 394;

    const containerWidth = screenWidth / ratiow;
    const containerHeight = screenHeight / ratioh;

    const ratioh2 = screenHeight > 592.0 ? screenHeight / 486 : screenHeight / 386;

    const containerHeight2 = screenHeight / ratioh2;

    const sr = screenHeight > 592.0 ? screenHeight / 14 : screenHeight / 8;
    const sizedboxH = screenHeight / sr;

    const sr1 = screenHeight > 592.0 ? screenHeight / 21 : screenHeight / 6;
    const sizedboxH1 = screenHeight / sr1;

    const sr2 = screenWidth > 592.0 ? screenWidth / 22 : screenWidth / 22;
    const sizedboxW1 = screenWidth / sr2;
    ...
    return Scaffold(
      ...
      body: WebView(
        innerContainerHeight: 843.4285714285714,
        innerContainerWidth: 411.42857142857144,
        innerContainerColor: const Color(0xff333333),
        child: ZoomedWidget(
          child: Column(
            ...
            children: [
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Divider(
                            color: controller.isValue != true ? const Color(0xff333333) : const Color.fromARGB(126, 255, 255, 255),
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  // color: Colors.amber,
                                  width: 411.42857142857144 * .645,
                                  // 273
                                  child: Text(
                                    textAlign: TextAlign.right,
                                    overflow: controller.AnsTF ? TextOverflow.visible : TextOverflow.ellipsis,
              ...
              Container(
                margin: screenHeight > 592.0 ? const EdgeInsets.only(top: 20) : const EdgeInsets.only(top: 10),
                ...
                child: Stack(
                  ...
                  children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    style: ElevatedButtonStyle.scientificBtn(context),
                                    onPressed: () {
                                      controller.getValue("(");
                                      controller.screenUp();
                                    },
                              ...
                              children: [
                                CustomContainerBox(
                                  child: Row(
                                    ...
                                    children: [
                                      ElevatedButton(
                                        style: ElevatedButtonStyle.operatorStyle(context),
                                        onPressed: () {
                                          controller.clear();
                                        },
                                        child: const Text(
                            ...
                            CustomContainerBox2(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    style: ElevatedButtonStyle.operatorStyleEquals(context),
                                    onPressed: () {
                                      controller.evaluate();
                                      controller.screenUp();
                                    },
                    ...
                    Container(
                      padding: screenHeight > 592 ? const EdgeInsets.only(bottom: 10) : const EdgeInsets.only(bottom: 5),
